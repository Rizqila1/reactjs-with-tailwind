  ...
  return (
    <nav className="xl:px-10 lg:px-10 mt-8">
      <section className="grid grid-cols-5 xl:grid-cols-5 md:grid-cols-5 sm:grid-cols-5 gap-4 items-center">
        ...
        {/* NAVBAR ICONS START */}
        <span className="xl:col-span-2 lg:col-span-2 md:col-span-5 sm:col-span-5 flex xl:justify-end lg:justify-end md:justify-center sm:justify-center">
          <button type="button">
            <FontAwesomeIcon icon="fa-solid fa-magnifying-glass" />
          </button>

          <button type="button" className="mx-12">
